...
import AddDomeSaleItem from "components/dome-sales/AddDomeSaleItem";
import EditDomeSaleItem from "components/dome-sales/EditDomeSaleItem";
...
function DomeSalesPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      selector: (row) => dayjs(row.startTime).format("DD-MM-YYYY HH:mm"),
      sortable: true,
      width: "200px",
      reorder: true,
    },
    {
      id: 4,
      name: "Sale end time",
      selector: (row) => dayjs(row.endTime).format("DD-MM-YYYY HH:mm"),
      sortable: true,
      width: "150px",
      reorder: true,
    },
              ...
              <DataTable
                ...
                title={
                  <div className="col-lg-6 mb-2 text-white text-uppercase">
                    <h2 className="font-weight-bold mb-2">Dome Sales</h2>
                  </div>
                }
                actions={
                  <div className="dropdown">
