...
import AddConsumable from "components/consumables/AddConsumable";
import EditConsumable from "components/consumables/EditConsumable";
import ViewConsumable from "components/consumables/ViewConsumable";
              ...
              <DataTable
                ...
                title={
                  <div className="col-lg-6 mb-2 text-white text-uppercase">
                    <h2 className="font-weight-bold mb-2">Consumable Items</h2>
                  </div>
                }
                actions={
                  <div className="dropdown">
